          ...
          <div className="container mx-auto px-6 lg:px-12">
            ...
            <form className="grid gap-4 rounded-2xl border border-border bg-card p-6 md:grid-cols-2" action="mailto:info@devanhaar.com" method="post" encType="text/plain">
              ...
              <div className="md:col-span-2 rounded-xl border border-border p-4">
                <label className="flex items-center gap-2 text-sm"><input type="checkbox" name="bringing_kids" /> Bringing Kids?</label>
                <label className="mt-2 flex items-center gap-2 text-sm"><input type="checkbox" name="kids_participating" /> Are they participating?</label>
                <textarea name="child_info" rows={3} placeholder="Child info if participating" className="mt-3 w-full rounded-xl border border-border bg-background px-4 py-3 text-sm" />
              </div>
