...
const sections: { h: string; blocks: Block[] }[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { t: "p", c: "Depending on the consent state and the form or feature used, technical records may include an IP address, form-submission metadata, and camp registration inputs. These are not used to activate analytics before consent and are handled under the Privacy Policy." },
  ...
  },
  {
    ...
    blocks: [
      ...
      { t: "h3", c: "Quick deletion instructions" },
      { t: "ul", c: ["Chrome: open Settings > Privacy and security > Delete browsing data, choose Cookies and other site data, then select the time range and delete.", "Safari: open Safari > Settings > Privacy > Manage Website Data, search for devanhaar.com, then Remove.", "Edge: open Settings > Privacy, search, and services > Clear browsing data, select Cookies and other site data, then clear the data."] },
