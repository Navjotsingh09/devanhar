...
const projects: Project[] = [
  ...
  },
  {
    ...
    description: "A family-focused retreat bringing parents, children and young people together through Gurbani, Sikh history, seva and time in sangat.",
          ...
          {projects.map((project) => {
            ...
            return (
              <Link key={project.title} href={project.href} className="group block">
                <div className={["relative aspect-[4/3] overflow-hidden rounded-sm", project.gradient || "bg-muted"].join(" ")}>
                  {!project.gradient && (
                    <Image
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6">
                    ...
                    <div className="max-h-0 opacity-0 group-hover:max-h-40 group-hover:opacity-100 transition-all duration-500 overflow-hidden">
                      ...
                      {project.comingSoon ? (
                        <span className="inline-flex items-center gap-1.5 text-amber-300 text-xs font-semibold mt-3 uppercase tracking-[0.15em]">
                          Coming Soon
                        </span>
                      ) : (
