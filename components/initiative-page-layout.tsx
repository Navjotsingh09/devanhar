...
export function InitiativePageLayout({
  ...
  const isSinghsCamp = title.trim().toLowerCase().startsWith("singhs camp")
        ...
        <div className="container mx-auto px-6 lg:px-12">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              {comingSoon ? (
                <div className="mt-8">
                  <span className="inline-flex items-center rounded-full bg-primary/15 px-6 py-3 text-sm font-semibold uppercase tracking-[0.15em] text-primary">
                    Coming Soon
                  </span>
                </div>
      ...
      {!hideCtaSection && <section className="py-16 lg:py-24 bg-foreground text-background">
        <div className="container mx-auto px-6 lg:px-12 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            {comingSoon ? (
              <span className="inline-flex items-center rounded-full bg-background/20 px-6 py-3 text-sm font-semibold uppercase tracking-[0.15em] text-background">
                Coming Soon
              </span>
            ) : ctaText && (effectiveCtaClick || ctaHref) && (
              effectiveCtaClick ? (
