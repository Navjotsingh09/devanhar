...
const galleryImages: GalleryImage[] = [
  ...
  { src: "https://placehold.co/600x400/1a1a2e/e0e0e0.png?text=Workshop+Session", alt: "Workshop session", category: "events", caption: "Community Workshop Session" },
  ...
  { src: "https://placehold.co/800x600/1a1a2e/e0e0e0.png?text=Panel+Discussion", alt: "Panel discussion", category: "events", caption: "University Talk \u2014 Interfaith Dialogue" },
...
const playlists: Playlist[] = [
  ...
  },
  {
    ...
    description: "Thought-provoking talks from university and community events.",
    videos: [
      { id: "DLzxrzFCyOs", title: "What Does Sikh Identity Mean Today?", duration: "22:10", description: "A panel exploring modern Sikh identity." },
