...
export function HeroSection() {
  ...
  const slideImages = [
    heroImages.find(i => i.category === "slide-1")?.url || "/hero-community.jpg",
    heroImages.find(i => i.category === "slide-2")?.url || "/community-event.jpg",
    heroImages.find(i => i.category === "slide-3")?.url || "/foundation.jpg",
  ]
