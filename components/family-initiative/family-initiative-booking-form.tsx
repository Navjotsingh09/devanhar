...
export function FamilyInitiativeBookingForm() {
  ...
  if (submitted) return <div ref={successRef} className="rounded-2xl border border-border bg-secondary/30 p-8 text-center md:p-12"><CheckCircle2 className="mx-auto mb-5 h-14 w-14 text-[hsl(43,100%,29%)]" /><h3 className="mb-4 text-2xl font-bold">Booking request received</h3><p className="mx-auto mb-7 max-w-xl leading-relaxed text-muted-foreground">Thank you. The Sikh Family Initiative team will review your Family Fun Day request and contact you to confirm the booking. No payment has been taken.</p><Button type="button" onClick={() => setSubmitted(false)} className="rounded-full bg-[hsl(43,100%,29%)] px-7 text-white hover:bg-[hsl(43,100%,25%)]">Submit another request</Button></div>
