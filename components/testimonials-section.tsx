...
const pillars = [
  ...
  },
  {
    ...
    description2:
      "Connection is the heartbeat of everything we do. From the friendships forged at Singhs Camps and Kaurs Camps to the mentor-mentee relationships built through Khalsa Catalyst, every programme strengthens the web of support that holds our community together.",
  },
]
