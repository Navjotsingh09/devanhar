...
const pillars = [
  ...
  },
  {
    ...
    description2:
      "Connection is the heartbeat of everything we do. From the friendships forged at Singhs Camps and Kaurs Camps to the mentor-mentee relationships built through our wider programmes, every initiative strengthens the web of support that holds our community together.",
  },
]
  ...
  return (
    <section className="py-20 md:py-28" style={{ backgroundColor: "#f8f8f8" }}>
      <div className="container mx-auto px-6 lg:px-12">
        <div data-animate className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8">
